class CreateDispatchCommissions < ActiveRecord::Migration
  def change
    create_table :dispatch_commissions do |t|
    ...
    add_index :dispatch_commissions, :account_id
    add_index :dispatch_commissions, :user_id
  end
end
