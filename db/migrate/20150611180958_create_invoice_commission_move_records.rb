class CreateInvoiceCommissionMoveRecords < ActiveRecord::Migration
  def change
    create_table :invoice_commission_move_records do |t|
    ...
    add_index :invoice_commission_move_records, :move_record_id
    add_index :invoice_commission_move_records, :account_id
    add_index :invoice_commission_move_records, :user_id
