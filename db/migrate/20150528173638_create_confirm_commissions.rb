class CreateConfirmCommissions < ActiveRecord::Migration
  def change
    create_table :confirm_commissions do |t|
    ...
    add_index :confirm_commissions, :account_id
    add_index :confirm_commissions, :user_id
  end
end
