class CreateLeadCommissions < ActiveRecord::Migration
  def change
    create_table :lead_commissions do |t|
    ...
    add_index :lead_commissions, :account_id
    add_index :lead_commissions, :user_id
  end
end
