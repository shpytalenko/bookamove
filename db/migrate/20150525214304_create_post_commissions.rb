class CreatePostCommissions < ActiveRecord::Migration
  def change
    create_table :post_commissions do |t|
    ...
    add_index :post_commissions, :account_id
    add_index :post_commissions, :user_id
  end
end
