class CreateAftercareCommissions < ActiveRecord::Migration
  def change
    create_table :aftercare_commissions do |t|
    ...
    add_index :aftercare_commissions, :account_id
    add_index :aftercare_commissions, :user_id
  end
end
