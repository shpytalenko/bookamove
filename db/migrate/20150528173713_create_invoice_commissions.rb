class CreateInvoiceCommissions < ActiveRecord::Migration
  def change
    create_table :invoice_commissions do |t|
    ...
    add_index :invoice_commissions, :account_id
    add_index :invoice_commissions, :user_id
  end
end
