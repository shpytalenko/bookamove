class CreateLeadCommissionMoveRecords < ActiveRecord::Migration
  def change
    create_table :lead_commission_move_records do |t|
    ...
    add_index :lead_commission_move_records, :move_record_id
    add_index :lead_commission_move_records, :account_id
    add_index :lead_commission_move_records, :user_id
