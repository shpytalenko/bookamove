class CreateConfirmCommissionMoveRecords < ActiveRecord::Migration
  def change
    create_table :confirm_commission_move_records do |t|
    ...
    add_index :confirm_commission_move_records, :move_record_id
    add_index :confirm_commission_move_records, :account_id
    add_index :confirm_commission_move_records, :user_id
