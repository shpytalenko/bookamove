class CreateQuoteCommissions < ActiveRecord::Migration
  def change
    create_table :quote_commissions do |t|
    ...
    add_index :quote_commissions, :account_id
    add_index :quote_commissions, :user_id
  end
end
