/*!
 FullCalendar Scheduler v1.0.0-beta
 */
!function (t) {
    "function" == typeof define && define.amd ? define(["jquery", "moment"], t) : t(jQuery, moment)
}(function (t, e) {
    var r, o, n, i, s, l, h, u, a, p, c, d, f, g, y, v, w, m, b, R, S, E, C, _, T, H, D, F, x, I, W, M, G, k, L, z, B, O, P, A, V, q, N, Y, j, U, X, Q, J, K, Z, $, tt, et, rt, ot, nt, it, st, lt, ht, ut, at, pt, ct, dt, ft, gt, yt, vt, wt, mt, bt = [].slice, Rt = function (t, e) {
        function r() {
            this.constructor = t
        }

        for (var o in e)St.call(e, o) && (t[o] = e[o]);
        return r.prototype = e.prototype, t.prototype = new r, t.__super__ = e.prototype, t
    }, St = {}.hasOwnProperty;
    a = t.fullCalendar, o = a.Calendar, i = a.Class, G = a.View, p = a.Grid, it = a.intersectionToSeg, O = a.compareSegs, Y = a.debounce, st = a.isInt, tt = a.getScrollbarWidths, l = a.DragListener, ot = a.htmlEscape, P = a.computeIntervalUnit, pt = a.proxy, B = a.capitaliseFirstLetter, L = a.applyAll, ct = null, ut = function (t, e) {
        var r, o;
        ...
        if (e = o.scrollLeft, "rtl" === r)switch (ct) {
            case"positive":
                e = e + o.clientWidth - o.scrollWidth;
                break;
            case"reverse":
        ...
        var e, r, o;
        if (e = t.css("direction"), r = t[0], o = r.scrollLeft, "rtl" === e)switch (ct) {
            case"negative":
        ...
        return e.prototype.callbackHash = null, e.prototype.on = function (t, e) {
            return this.getCallbacks(t).add(e), this
        }, e.prototype.off = function (t, e) {
            return this.getCallbacks(t).remove(e), this
        }, e.prototype.trigger = function () {
            var t, e, r;
            return e = arguments[0], t = 2 <= arguments.length ? bt.call(arguments, 1) : [], (r = this.getCallbacks(e)).fire.apply(r, t), this
        }, e.prototype.getCallbacks = function (e) {
            var r;
            return this.callbackHash || (this.callbackHash = {}), (r = this.callbackHash)[e] || (r[e] = t.Callbacks())
        }, e
    }(), F = function () {
        function e(e, r) {
            this.overflowX = null != e ? e : "auto", this.overflowY = null != r ? r : "auto", this.el = t('<div class="fc-scrollpane"> <div> <div class="fc-scrollpane-inner"> <div class="fc-content"/> <div class="fc-bg"/> </div> </div> </div>'), this.scrollEl = this.el.children(), this.innerEl = this.scrollEl.children(), this.contentEl = this.innerEl.find(".fc-content"), this.bgEl = this.innerEl.find(".fc-bg"), this.scrollEl.on("scroll", pt(this, "handleScroll")).on("scroll", Y(pt(this, "handleScrollStop"), 100)), this.handlers = {}, this.gutters = {}
        }

        return e.prototype.el = null, e.prototype.innerEl = null, e.prototype.contentEl = null, e.prototype.bgEl = null, e.prototype.overflowX = null, e.prototype.overflowY = null, e.prototype.isScrolling = !1, e.prototype.handlers = null, e.prototype.update = function () {
            var t, e, r, o, n, i, s;
            return i = this.scrollEl, o = this.overflowX, n = this.overflowY, e = "invisible-scroll" === o, r = "invisible-scroll" === n, i.css({
                ...
                marginTop: 0,
                marginBottom: 0
            }, (e || r) && (s = tt(i), e && (t.marginTop = -s.top, t.marginBottom = -s.bottom), r && (t.marginLeft = -s.left, t.marginRight = -s.right)), i.css(t)
        }, e.prototype.getScrollbarWidths = function () {
            var t;
            return t = tt(this.scrollEl), "invisible-scroll" === this.overflowX && (t.top = 0, t.bottom = 0), "invisible-scroll" === this.overflowY && (t.left = 0, t.right = 0), t
        ...
        }, e.prototype.height = null, e.prototype.contentWidth = null, e.prototype.contentMinWidth = null, e.prototype.gutters = null, e.prototype.setHeight = function (t) {
            ...
            }), this.bgEl.css({left: t.left || "", right: t.right || "", top: t.top || "", bottom: t.bottom || ""})
            ...
            var t, e, r, o, n, i;
            for (r = arguments[0], t = 2 <= arguments.length ? bt.call(arguments, 1) : [], i = this.handlers[r] || [], o = 0, n = i.length; n > o; o++)e = i[o], e.apply(this, t)
        }, e
    }(), rt = function (t) {
        var e;
        return e = tt(t), e.left || e.right || e.top || e.bottom
    }, D = function () {
        function t(t, e) {
            var r, o, n, i;
        ...
        return t.prototype.axis = null, t.prototype.scrollers = null, t.prototype.masterScroller = null, t.prototype.enabled = !0, t.prototype.enable = function () {
            ...
            return t.on("scrollStart", function (e) {
                ...
                return function (r, o) {
                    var n, i, s, l;
                    if (t === e.masterScroller)for (l = e.scrollers, n = 0, i = l.length; i > n; n++)if (s = l[n], s !== e.masterScroller)switch (e.axis) {
                        case"horizontal":
                            s.scrollLeft(o);
                            break;
                        case"vertical":
            ...
            var t, e, r, o, n, i, s, l, h, u, a, p, c;
            for (t = function () {
                var t, e, r, o;
                for (r = this.scrollers, o = [], t = 0, e = r.length; e > t; t++)p = r[t], o.push(p.getScrollbarWidths());
                return o
            }.call(this), l = h = u = s = 0, r = 0, n = t.length; n > r; r++)c = t[r], l = Math.max(l, c.left), h = Math.max(h, c.right), u = Math.max(u, c.top), s = Math.max(s, c.bottom);
            for (a = this.scrollers, e = o = 0, i = a.length; i > o; e = ++o)p = a[e], c = t[e], p.setGutters("horizontal" === this.axis ? {
                left: l - c.left,
                right: h - c.right
            } : {top: u - c.top, bottom: s - c.bottom})
        }, t
    }(), T = function () {
        function e(t) {
            this.scroller = t, this.sprites = [], this.scroller.on("scrollStart", function (t) {
                ...
                return function (e, r) {
                    var o, n, i;
                    return n = t.scroller.scrollEl, o = $(n), i = n.scrollTop(), t.viewportRect = {
                        left: o,
        ...
        return e.prototype.scroller = null, e.prototype.scrollbarWidths = null, e.prototype.sprites = null, e.prototype.viewportRect = null, e.prototype.contentOffset = null, e.prototype.isHFollowing = !0, e.prototype.isVFollowing = !1, e.prototype.containOnNaturalLeft = !1, e.prototype.containOnNaturalRight = !1, e.prototype.shouldRequeryDimensions = !1, e.prototype.minTravel = 0, e.prototype.isForcedAbsolute = !1, e.prototype.isForcedRelative = !1, e.prototype.setSprites = function (e) {
            ...
            if (this.clearSprites(), e instanceof t)return this.sprites = function () {
                var r, o, i;
                for (i = [], r = 0, o = e.length; o > r; r++)n = e[r], i.push(new H(t(n), this));
                return i
            }.call(this);
            ...
            var t, e, r, o, n, i, s;
            for (n = this.scroller.scrollEl, e = $(n), s = n.scrollTop(), this.viewportRect = {
                left: e,
        ...
        return t.prototype.follower = null, t.prototype.el = null, t.prototype.absoluteEl = null, t.prototype.naturalRect = null, t.prototype.parentRect = null, t.prototype.containerRect = null, t.prototype.isEnabled = !0, t.prototype.isHFollowing = !1, t.prototype.isVFollowing = !1, t.prototype.doAbsolute = !1, t.prototype.isAbsolute = !1, t.prototype.isCentered = !1, t.prototype.rect = null, t.prototype.isBlock = !1, t.prototype.naturalWidth = null, t.prototype.disable = function () {
            ...
            var t, e, r, o, n, i, s, l;
            return o = !1, n = !1, r = !1, this.naturalWidth = this.el.width(), this.resetPosition(), e = this.follower, s = this.naturalRect = e.getBoundingRect(this.el), l = this.el.parent(), this.parentRect = e.getBoundingRect(l), t = this.containerRect = lt(e.getContentRect(l), s), i = e.minTravel, e.containOnNaturalLeft && (t.left = s.left), e.containOnNaturalRight && (t.right = s.right), e.isHFollowing && Z(t) - Z(s) >= i && (r = "center" === this.el.css("text-align"), o = !0), e.isVFollowing && K(t) - K(s) >= i && (n = !0), this.isHFollowing = o, this.isVFollowing = n, this.isCentered = r
            ...
            var t, e, r, o, n, i, s, l;
            return s = this.follower.viewportRect, r = this.parentRect, t = this.containerRect, l = nt(s, r), o = null, e = !1, l && (o = q(this.naturalRect), i = nt(o, r), (this.isCentered && !dt(s, r) || i && !dt(s, i)) && (e = !0, this.isHFollowing && (this.isCentered ? (n = Z(o), o.left = (l.left + l.right) / 2 - n / 2, o.right = o.left + n) : et(o, s) || (e = !1), et(o, t) && (e = !1)), this.isVFollowing && (wt(o, s) || (e = !1), wt(o, t) && (e = !1)), dt(s, o) || (e = !1))), this.rect = o, this.doAbsolute = e
        ...
        return ft(t, e) && yt(t, e)
    }, ft = function (t, e) {
        return e.left >= t.left && e.right <= t.right
    }, yt = function (t, e) {
        return e.top >= t.top && e.bottom <= t.bottom
    }, et = function (t, e) {
        return t.left < e.left ? (t.right = e.left + Z(t), t.left = e.left, !0) : t.right > e.right ? (t.left = e.right - Z(t), t.right = e.right, !0) : !1
    }, wt = function (t, e) {
        return t.top < e.top ? (t.bottom = e.top + K(t), t.top = e.top, !0) : t.bottom > e.bottom ? (t.top = e.bottom - K(t), t.bottom = e.bottom, !0) : !1
    }, nt = function (t, e) {
        return gt(t, e) ? {
        ...
        return Rt(e, t), e.prototype.resourceManager = null, e.prototype.initialize = function () {
            return this.resourceManager = new w(this)
        }, e.prototype.instantiateView = function (t) {
            var e, r;
            return e = this.getViewSpec(t), r = e["class"], this.options.resources && e.options.resources !== !1 && e.resourceClass && (r = e.resourceClass), new r(this, t, e.options, e.duration)
            ...
            return this.resourceManager.fetchResources()
        }, e.prototype.rerenderResources = function () {
            var t;
            return "function" == typeof(t = this.view).redisplayResources ? t.redisplayResources() : void 0
            ...
            var o, n, i, s, l, h, u;
            for (l = e.__super__.getPeerEvents.apply(this, arguments), u = r.resourceId || "", o = [], n = 0, i = l.length; i > n; n++)s = l[n], h = this.getEventResourceId(s) || "", h && h !== u || o.push(s);
            return o
        }, e.prototype.buildSelectRange = function (t, r, o) {
            var n;
            return n = e.__super__.buildSelectRange.apply(this, arguments), o && (n.resourceId = o), n
        }, e
    }(o), o.prototype = n.prototype, k = function (t) {
        function e() {
            return e.__super__.constructor.apply(this, arguments)
        }

        return Rt(e, t), e.prototype.isResourceListening = !1, e.prototype.displayEvents = function (t) {
            return this.listenToResources(), this.calendar.resourceManager.getResources().then(function (r) {
                return function () {
                    return e.__super__.displayEvents.call(r, t)
                }
            }(this))
        }, e.prototype.listenToResources = function () {
            return this.isResourceListening ? void 0 : (this.calendar.resourceManager.on("add", pt(this, "addResource")).on("remove", pt(this, "removeResource")).on("reset", pt(this, "resetResources")), this.isResourceListening = !0)
        }, e.prototype.addResource = function (t) {
            return this.calendar.rerenderEvents()
        }, e.prototype.removeResource = function (t) {
            return this.calendar.rerenderEvents()
        }, e.prototype.resetResources = function (t) {
            return this.calendar.rerenderEvents()
        }, e
    }(G), G.prototype = k.prototype, p.prototype.getEventSkinCss = function (t) {
        var e, r, o, n, i, s, l, h, u, a, p;
        return p = this.view, u = t.source || {}, e = t.color, a = u.color, i = p.opt("eventColor"), s = null, h = p.calendar.resourceManager, l = h.getEventResourceId(t), l && (s = h.getResourceById(l)), r = function () {
            var t, e;
            ...
            "background-color": t.backgroundColor || e || r() || u.backgroundColor || a || p.opt("eventBackgroundColor") || i,
            "border-color": t.borderColor || e || o() || u.borderColor || a || p.opt("eventBorderColor") || i,
            color: t.textColor || n() || u.textColor || p.opt("eventTextColor")
        }
    }, w = function (e) {
        function r(t) {
        ...
        return Rt(r, e), r.mixin(h), r.resourceGuid = 1, r.ajaxDefaults = {
            dataType: "json",
            cache: !1
        }, r.prototype.calendar = null, r.prototype.topLevelResources = null, r.prototype.resourcesById = null, r.prototype.getting = null, r.prototype.fetching = null, r.prototype.getResources = function () {
            var e;
            return e = this.getting, e || (e = this.getting = t.Deferred(), this.fetchResources().done(function (t) {
                return e.resolve(t)
            }).fail(function () {
                return e.resolve([])
            })), e.promise()
            ...
            var e, o, n;
            switch (e = t.Deferred(), n = this.calendar.options.resources, "string" === t.type(n) && (n = {url: n}), t.type(n)) {
                case"function":
                    n(function (t) {
                        return function (t) {
                            return e.resolve(t)
            ...
            var e, r, o, n;
            if (this.resourcesById[t._id])return !1;
            for (this.resourcesById[t._id] = t, n = t.children, r = 0, o = n.length; o > r; r++)e = n[r], this.addResourceToIndex(e);
            return !0
        }, r.prototype.addResourceToTree = function (t) {
            var e, r;
            if (!t._parent) {
                if (t._parentId) {
                    if (e = this.resourcesById[t._parentId], !e)return !1;
                    t._parent = e, r = e.children
            ...
            var r;
            return r = "object" == typeof e ? e._id : e, t.when(this.fetching).then(function (t) {
                return function () {
                    var e;
            ...
            if (i = this.resourcesById[t]) {
                for (delete this.resourcesById[t], n = i.children, r = 0, o = n.length; o > r; r++)e = n[r], this.removeResourceFromIndex(e._id);
                return i
            }
            return !1
            ...
            for (null == e && (e = this.topLevelResources), r = o = 0, n = e.length; n > o; r = ++o) {
                if (i = e[r], i === t)return t._parent = null, e.splice(r, 1), !0;
                if (this.removeResourceFromTree(t, i.children))return !0
            }
            return !1
        }, r.prototype.buildResource = function (e) {
            var o, n, i, s, l;
            return l = t.extend({}, e), l._id = String((null != (s = e.id) ? s : "_fc" + r.resourceGuid++) || ""), l._parentId = String(e[this.getResourceParentField()] || ""), i = e.className, l.className = function () {
                switch (t.type(i)) {
                    case"string":
                        return i.split(/\s+/);
                    case"array":
                ...
                var t, r, i, s, h;
                for (s = null != (i = e.children) ? i : [], h = [], t = 0, r = s.length; r > t; t++)n = s[t], o = this.buildResource(n), o._parent = l, h.push(o);
                return h
            }.call(this), l
        }, r.prototype.getResourceParentField = function () {
            return this.calendar.options.resourceParentProperty || "parentId"
            ...
            return this.calendar.options.eventResourceProperty || "resourceId"
        }, r
    }(i), S = function (e) {
        function r() {
        ...
        return Rt(r, e), r.prototype.displayingResources = null, r.prototype.assigningResources = null, r.prototype.displayView = function () {
        ...
        }, r.prototype.renderStoredResources = function () {
        }, r.prototype.unrenderStoredResources = function () {
        }, r.prototype.triggerDayClick = function (t, e, r) {
            var o;
            return o = this.calendar.resourceManager, this.trigger("dayClick", e, t.start, r, this, o.getResourceById(t.resourceId))
        }, r.prototype.triggerSelect = function (t, e) {
            var r;
            return r = this.calendar.resourceManager, this.trigger("select", null, t.start, t.end, e, this, r.getResourceById(t.resourceId))
        }, r
    }(G), v = function (t) {
        function e() {
            return e.__super__.constructor.apply(this, arguments)
        ...
        return Rt(e, t), e.prototype.eventsToRanges = function (t) {
            var r, o, n, i;
            for (o = e.__super__.eventsToRanges.apply(this, arguments), n = 0, i = o.length; i > n; n++)r = o[n], r.resourceId = this.view.calendar.getEventResourceId(r.event);
            return o
        }, e.prototype.eventRangeToSegs = function (t) {
            var r, o, n, i, s;
            if (s = e.__super__.eventRangeToSegs.apply(this, arguments), n = t.resourceId)for (r = 0, o = s.length; o > r; r++)i = s[r], i.resourceId = n;
            return s
        }, e.prototype.selectionRangeToSegs = function (t) {
            var r, o, n, i, s;
            if (s = e.__super__.selectionRangeToSegs.apply(this, arguments), n = t.resourceId)for (r = 0, o = s.length; o > r; r++)i = s[r], i.resourceId = n;
            return s
            ...
            var n, i;
            return r.resourceId ? (n = !0, n || t.resourceId === r.resourceId ? (i = e.__super__.computeEventDrop.apply(this, arguments), i && (i.resourceId = r.resourceId), i) : null) : null
        }, e.prototype.computeExternalDrop = function (t, r) {
            var o;
            return t.resourceId ? (o = e.__super__.computeExternalDrop.apply(this, arguments), o && (o.resourceId = t.resourceId), o) : null
        }, e.prototype.computeEventResize = function (t, r, o, n) {
            var i;
            return i = e.__super__.computeEventResize.apply(this, arguments), i && (i.resourceId = r.resourceId), i
        }, e.prototype.computeSelection = function (t, r) {
            var o;
            return o = e.__super__.computeSelection.apply(this, arguments), o && (o.resourceId = t.resourceId), o
        }, e
    }(p), W = function (t) {
        function e() {
            return e.__super__.constructor.apply(this, arguments)
        ...
        return Rt(e, t), e.prototype.timeGrid = null, e.prototype.isScrolled = !1, e.prototype.initialize = function () {
            return this.timeGrid = this.instantiateGrid(), this.intervalDuration = this.timeGrid.duration, this.coordMap = this.timeGrid.coordMap
            ...
            return this.timeGrid.setElement(this.el.find("tbody .fc-time-area")), this.timeGrid.headEl = this.el.find("thead .fc-time-area"), this.timeGrid.renderSkeleton(), this.timeGrid.bodyScroller.on("scroll", pt(this, "handleBodyScroll"))
        ...
        return Rt(o, r), o.prototype.slotDates = null, o.prototype.headEl = null, o.prototype.slatContainerEl = null, o.prototype.slatEls = null, o.prototype.slatElCoords = null, o.prototype.headScroller = null, o.prototype.bodyScroller = null, o.prototype.joiner = null, o.prototype.follower = null, o.prototype.eventTitleFollower = null, o.prototype.minTime = null, o.prototype.maxTime = null, o.prototype.slotDuration = null, o.prototype.snapDuration = null, o.prototype.slotCnt = null, o.prototype.snapDiffToCol = null, o.prototype.colToSnapDiff = null, o.prototype.colsPerSlot = null, o.prototype.duration = null, o.prototype.labelInterval = null, o.prototype.headerFormats = null, o.prototype.isTimeScale = null, o.prototype.emphasizeWeeks = !1, o.prototype.titleFollower = null, o.prototype.segContainerEl = null, o.prototype.segContainerHeight = null, o.prototype.bgSegContainerEl = null, o.prototype.helperEls = null, o.prototype.innerEl = null, o.prototype.opt = function (t) {
            ...
            return this.isTimeScale ? this.view.calendar.rezoneDate(t) : this.largeUnit ? t.clone().startOf(this.largeUnit) : t.clone().stripTime()
            ...
            var t, e, r, o, n;
            for (t = -1, n = 0, o = [], e = [], r = this.start.clone(); r < this.end;)this.isValidDate(r) ? (t++, o.push(t), e.push(n)) : o.push(t + .5), r.add(this.snapDuration), n++;
            return this.snapDiffToCol = o, this.colToSnapDiff = e, this.colCnt = t + 1
        }, o.prototype.build = function () {
            return this.rowCnt = 1
        }, o.prototype.getRowEl = function () {
            return this.bodyScroller.contentEl
        }, o.prototype.getCellDayEl = function (t) {
            return this.slatEls.eq(Math.floor(t.col / this.colsPerSlot))
        }, o.prototype.computeColCoords = function () {
            var t, e;
            for (t = [], e = this.start.clone(); e < this.end;)this.isValidDate(e) && t.push(this.rangeToOffsets({
                start: e,
                end: e.clone().add(this.snapDuration)
            })), e.add(this.snapDuration);
            return t
        }, o.prototype.computeCellRange = function (t) {
            var e, r;
            return r = this.start.clone(), r.add(ht(this.snapDuration, this.colToSnapDiff[t.col])), e = r.clone().add(this.snapDuration), {
                start: r,
                end: e
            }
        }, o.prototype.rangeToSegs = function (t) {
            var e, r, o, n;
            return this.isTimeScale ? o = t : (o = this.view.computeDayRange(t), this.largeUnit && (r = o.start.clone().startOf(this.largeUnit), e = o.end.clone().startOf(this.largeUnit), e.isSame(o.end) && e.isAfter(r) || e.add(this.slotDuration), o = {
                start: r,
                end: e
            })), n = it(o, this.view), n ? (n.isStart && !this.isValidDate(n.start) && (n.isStart = !1),
            n.isEnd && n.end && !this.isValidDate(n.end.clone().subtract(1)) && (n.isEnd = !1), [n]) : []
        }, o.prototype.renderSkeleton = function () {
            return this.headScroller = new F("invisible-scroll", "hidden"), this.headEl.append(this.headScroller.el), this.bodyScroller = new F, this.el.append(this.bodyScroller.el), this.innerEl = this.bodyScroller.contentEl, this.slatContainerEl = t('<div class="fc-slats"/>').appendTo(this.bodyScroller.bgEl), this.segContainerEl = t('<div class="fc-event-container"/>').appendTo(this.bodyScroller.contentEl), this.bgSegContainerEl = this.bodyScroller.contentEl, this.coordMap.containerEl = this.bodyScroller.scrollEl, this.joiner = new D("horizontal", [this.headScroller, this.bodyScroller]), this.follower = new T(this.headScroller), this.eventTitleFollower = new T(this.bodyScroller), this.eventTitleFollower.minTravel = 50, this.isRTL ? this.eventTitleFollower.containOnNaturalRight = !0 : this.eventTitleFollower.containOnNaturalLeft = !0, o.__super__.renderSkeleton.apply(this, arguments)
        }, o.prototype.headColEls = null, o.prototype.slatColEls = null, o.prototype.renderDates = function () {
            var t, e, r, o, n;
            for (this.headScroller.contentEl.html(this.renderHeadHtml()), this.headColEls = this.headScroller.contentEl.find("col"), this.slatContainerEl.html(this.renderSlatHtml()), this.slatColEls = this.slatContainerEl.find("col"), this.slatEls = this.slatContainerEl.find("td"), n = this.slotDates, e = r = 0, o = n.length; o > r; e = ++r)t = n[e], this.view.trigger("dayRender", null, t, this.slatEls.eq(e));
            ...
            var t, e, r, o, n, i, s, l, h, u, a, p, c, d, f, g, y, v, w, m, b, R, S, E, C, _, T, H, D, F, x, I, W, M, G, k;
            for (f = this.labelInterval, n = this.headerFormats, e = function () {
                var t, e, r;
                for (r = [], t = 0, e = n.length; e > t; t++)o = n[t], r.push([]);
                return r
            }(), g = null, T = null, M = this.slotDates, W = [], p = 0, y = M.length; y > p; p++) {
                for (r = M[p], k = r.week(), a = this.emphasizeWeeks && null !== T && T !== k, F = c = 0, v = n.length; v > c; F = ++c)o = n[F], x = e[F], g = x[x.length - 1], u = n.length > 1 && F < n.length - 1, C = null, u ? (G = r.format(o), g && g.text === G ? g.colspan += 1 : C = {
                    text: G,
                    colspan: 1
                }) : !g || st(X(this.start, r, f)) ? (G = r.format(o), C = {
                    text: G,
                    colspan: 1
                }) : g.colspan += 1, C && (C.weekStart = a, x.push(C));
                W.push({weekStart: a}), T = k
            }
            for (l = f > this.slotDuration, i = "<table>", i += "<colgroup>", d = 0, w = M.length; w > d; d++)r = M[d], i += "<col/>";
            for (i += "</colgroup>", i += "<tbody>", s = E = 0, m = e.length; m > E; s = ++E) {
                for (x = e[s], h = s === e.length - 1, i += "<tr" + (l && h ? ' class="fc-chrono"' : "") + ">", _ = 0, b = x.length; b > _; _++)t = x[_], i += '<th class="' + this.view.widgetHeaderClass + " " + (t.weekStart ? "fc-em-cell" : "") + '"' + (t.colspan > 1 ? ' colspan="' + t.colspan + '"' : "") + '><div class="fc-cell-content"><span class="fc-cell-text">' + ot(t.text) + "</span></div></th>";
                i += "</tr>"
            }
            for (i += "</tbody></table>", I = "<table>", I += "<colgroup>", H = 0, R = W.length; R > H; H++)t = W[H], I += "<col/>";
            for (I += "</colgroup>", I += "<tbody><tr>", s = D = 0, S = W.length; S > D; s = ++D)t = W[s], r = M[s], I += this.slatCellHtml(r, t.weekStart);
            return I += "</tr></tbody></table>", this._slatHtml = I, i
        }, o.prototype.renderSlatHtml = function () {
            return this._slatHtml
        }, o.prototype.slatCellHtml = function (t, e) {
            var r;
            return this.isTimeScale ? (r = [], r.push((t - this.start) % this.labelInterval === 0 ? "fc-major" : "fc-minor")) : (r = this.getDayClasses(t), r.push("fc-day")), r.unshift(this.view.widgetContentClass), e && r.push("fc-em-cell"), '<td class="' + r.join(" ") + '" data-date="' + t.format() + '"><div /></td>'
            ...
            }), e = o + 1, s = U(this.labelInterval, this.slotDuration), i = Math.ceil(e / s), n = this.headColEls.eq(0).css("min-width"), n && (n = parseInt(n, 10), n && (i = Math.max(i, n))), i
        }, o.prototype.updateSlatElCoords = function () {
            var e, r, o, n, i, s;
            return r = this.slatEls.find("> div"), i = this.bodyScroller.innerEl, this.isRTL ? (n = i.offset().left + i.outerWidth(), e = function () {
                var e, i, l;
                for (l = [], o = e = 0, i = r.length; i > e; o = ++e)s = r[o], l.push(t(s).offset().left + t(s).outerWidth() - n);
                return l
            }(), e[o] = t(s).offset().left - n) : (n = i.offset().left, e = function () {
                var e, i, l;
                for (l = [], o = e = 0, i = r.length; i > e; o = ++e)s = r[o], l.push(t(s).offset().left - n);
                return l
            }(), e[o] = t(s).offset().left + t(s).outerWidth() - n), this.slatElCoords = e
        }, o.prototype.dateToCol = function (t) {
            var e, r, o, n;
            return r = X(this.start, t, this.snapDuration), 0 > r ? 0 : r >= this.snapDiffToCol.length ? this.colCnt : (o = Math.floor(r), n = r - o, e = this.snapDiffToCol[o], st(e) && n && (e += n), e)
        }, o.prototype.dateToCoord = function (t) {
            var e, r, o, n, i, s, l, h;
            return e = this.dateToCol(t), h = e / this.colsPerSlot, h = Math.max(h, 0), h = Math.min(h, this.slotDates.length), st(h) ? this.slatElCoords[h] : (n = Math.floor(h), i = +this.slotDates[n], s = +this.slotDates[n].clone().add(this.slotDuration), l = (t - i) / (s - i), l = Math.min(l, 1), r = this.slatElCoords[n], o = this.slatElCoords[n + 1], r + (o - r) * l)
        }, o.prototype.rangeToCoords = function (t) {
            return this.isRTL ? {
                right: this.dateToCoord(t.start),
                left: this.dateToCoord(t.end)
            } : {left: this.dateToCoord(t.start), right: this.dateToCoord(t.end)}
        }, o.prototype.rangeToOffsets = function (t) {
            var e, r;
            return e = this.rangeToCoords(t), r = this.isRTL ? this.slatContainerEl.offset().left + this.slatContainerEl.outerWidth() : this.slatContainerEl.offset().left, e.left += r, e.right += r, e
            ...
            return {left: ut(this.bodyScroller.scrollEl), top: this.bodyScroller.scrollEl.scrollTop()}
        }, o.prototype.setScroll = function (t) {
            return ut(this.bodyScroller.scrollEl, t.left), this.bodyScroller.scrollEl.scrollTop(t.top)
        }, o.prototype.renderFgSegs = function (t) {
            return t = this.renderFgSegEls(t), this.renderFgSegsInContainers([[this, t]]), this.updateSegFollowers(t), t
            ...
            var e, r, o, n, i, s, l, h, u, a, p, c, d, f, g, y, v, w, m, b, R, S, E, C, _;
            for (o = 0, s = t.length; s > o; o++)for (w = t[o], e = w[0], _ = w[1], n = 0, l = _.length; l > n; n++)C = _[n], r = this.rangeToCoords(C, -1), C.el.css({
                left: C.left = r.left,
                right: -(C.right = r.right)
            });
            for (i = 0, h = t.length; h > i; i++)for (m = t[i], e = m[0], _ = m[1], f = 0, u = _.length; u > f; f++)C = _[f], C.el.appendTo(e.segContainerEl);
            for (g = 0, a = t.length; a > g; g++) {
                for (b = t[g], e = b[0], _ = b[1], y = 0, p = _.length; p > y; y++)C = _[y], C.height = C.el.outerHeight(!0);
                z(_), e.segContainerHeight = V(_)
            }
            for (S = [], v = 0, c = t.length; c > v; v++) {
                for (R = t[v], e = R[0], _ = R[1], E = 0, d = _.length; d > E; E++)C = _[E], C.el.css("top", C.top);
                S.push(e.segContainerEl.height(e.segContainerHeight))
            }
            return S
            ...
            var r, o, n, i, s, l;
            return o = t.event, n = this.view.isEventDraggable(o), s = t.isStart && this.view.isEventResizableFromStart(o), i = t.isEnd && this.view.isEventResizableFromEnd(o), r = this.getSegClasses(t, n, s || i), r.unshift("fc-timeline-event", "fc-h-event"), l = this.getEventTimeText(t.event), '<div class="' + r.join(" ") + '" style="' + N(this.getEventSkinCss(t.event)) + '"><div class="fc-content">' + (l ? '<span class="fc-time">' + ot(l) + "</span>" : "") + '<span class="fc-title">' + ot(t.event.title) + '</span></div><div class="fc-bg" />' + (s ? '<div class="fc-resizer fc-start-resizer"></div>' : "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>' : "") + "</div>"
        }, o.prototype.updateSegFollowers = function (t) {
            var e, r, o, n, i;
            if (this.eventTitleFollower) {
                for (n = [], e = 0, r = t.length; r > e; e++)o = t[e], i = o.el.find(".fc-title"), i.length && n.push(new H(i));
            ...
            var r;
            return r = this.eventsToSegs([t]), r = this.renderFgSegEls(r), this.renderHelperSegsInContainers([[this, r]], e)
        }, o.prototype.renderHelperSegsInContainers = function (e, r) {
            var o, n, i, s, l, h, u, a, p, c, d, f, g, y, v, w, m;
            for (s = [], l = 0, a = e.length; a > l; l++)for (g = e[l], o = g[0], m = g[1], h = 0, p = m.length; p > h; h++)w = m[h], n = this.rangeToCoords(w, -1), w.el.css({
                left: w.left = n.left,
                right: -(w.right = n.right)
            }), r && r.resourceId === (null != (y = o.resource) ? y._id : void 0) ? w.el.css("top", r.el.css("top")) : w.el.css("top", 0);
            for (u = 0, c = e.length; c > u; u++)for (v = e[u], o = v[0], m = v[1], i = t('<div class="fc-event-container fc-helper-container"/>').appendTo(o.innerEl), s.push(i[0]), f = 0, d = m.length; d > f; f++)w = m[f], i.append(w.el);
            ...
            return this.renderHighlight(this.eventRangeToSegs(t)), this.renderRangeHelper(t, e)
            ...
            return e = this.renderFillSegEls(t, e), this.renderFillInContainers(t, [[this, e]], r), e
        }, o.prototype.renderFillInContainers = function (t, e, r) {
            var o, n, i, s, l, h;
            for (l = [], n = 0, i = e.length; i > n; n++)s = e[n], o = s[0], h = s[1], l.push(this.renderFillInContainer(t, o, h, r));
            return l
        }, o.prototype.renderFillInContainer = function (e, r, o, n) {
            var i, s, l, h, u;
            if (o.length) {
                for (n || (n = e.toLowerCase()), i = t('<div class="fc-' + n + '-container" />').appendTo(r.bgSegContainerEl), l = 0, h = o.length; h > l; l++)u = o[l], s = this.rangeToCoords(u, -1), u.el.css({
                    left: u.left = s.left,
                    right: -(u.right = s.right)
                }), u.el.appendTo(i);
                return this.elsByFill[e] = this.elsByFill[e] ? this.elsByFill[e].add(i) : i
            }
        }, o.prototype.renderDrag = function (t, e) {
            return e ? (this.renderRangeHelper(t, e), this.applyDragOpacity(this.helperEls), !0) : (this.renderHighlight(this.eventRangeToSegs(t)), !1)
        }, o.prototype.unrenderDrag = function () {
            return this.unrenderHelper(), this.unrenderHighlight()
        }, o
    }(p), Q = a.durationHasTime, X = function (t, e, r) {
        var o;
        return Q(r) ? (e - t) / r : (o = r.asMonths(), Math.abs(o) >= 1 && st(o) ? e.diff(t, "months", !0) / o : e.diff(t, "days", !0) / r.asDays())
    }, U = function (t, e) {
        var r, o;
        return Q(t) || Q(e) ? t / e : (r = t.asMonths(), o = e.asMonths(), Math.abs(r) >= 1 && st(r) && Math.abs(o) >= 1 && st(o) ? r / o : t.asDays() / e.asDays())
    }, ht = function (t, r) {
        var o;
        return Q(t) ? e.duration(t * r) : (o = t.asMonths(), e.duration(Math.abs(o) >= 1 && st(o) ? {months: o * r} : {days: t.asDays() * r}))
    }, z = function (t) {
        var e, r, o, n, i, s, l, h, u, a, p, c, d, f;
        for (d = [], t.sort(O), o = 0, s = t.length; s > o; o++) {
            for (f = t[o], f.above = [], u = 0; u < d.length;) {
                for (r = !1, p = d[u], n = 0, l = p.length; l > n; n++)a = p[n], vt(f, a) && (f.above.push(a), r = !0);
                if (!r)break;
                u += 1
            }
            for ((d[u] || (d[u] = [])).push(f), u += 1; u < d.length;) {
                for (c = d[u], i = 0, h = c.length; h > i; i++)e = c[i], vt(f, e) && e.above.push(f);
                u += 1
            }
        }
        return d
        ...
        var e, r, o, n;
        for (o = 0, e = 0, r = t.length; r > e; e++)n = t[e], o = Math.max(o, A(n));
        return o
    }, A = function (t) {
        return null == t.top && (t.top = V(t.above)), t.top + t.height
    }, vt = function (t, e) {
        return t.left < e.right && t.right > e.left
    }, y = 18, f = 6, d = 200, g = 1e3, s = {months: 1}, _ = [{years: 1}, {months: 1}, {days: 1}, {hours: 1}, {minutes: 30}, {minutes: 15}, {minutes: 10}, {minutes: 5}, {minutes: 1}, {seconds: 30}, {seconds: 15}, {seconds: 10}, {seconds: 5}, {seconds: 1}, {milliseconds: 500}, {milliseconds: 100}, {milliseconds: 10}, {milliseconds: 1}], I.prototype.initScaleProps = function () {
        var e, r;
        return this.labelInterval = this.queryDurationOption("slotLabelInterval"), this.slotDuration = this.queryDurationOption("slotDuration"), this.validateLabelAndSlot(), this.ensureGridDuration(), this.ensureLabelInterval(), this.ensureSlotDuration(), this.headerFormats = (e = this.opt("timelineHeader")) && t.isArray(e) ? e : this.computeHeaderFormats(), this.isTimeScale = Q(this.slotDuration), this.largeUnit = this.isTimeScale ? void 0 : (r = P(this.slotDuration), /year|month|week/.test(r) ? r : void 0), this.emphasizeWeeks = 1 === this.slotDuration.as("days") && this.duration.as("weeks") >= 2 && !this.opt("businessHours")
    }, I.prototype.queryDurationOption = function (t) {
        var r, o;
        return o = this.opt(t), null != o && (r = e.duration(o), +r) ? r : void 0
    }, I.prototype.validateLabelAndSlot = function () {
        var t, e, r;
        return this.duration && (this.labelInterval && (t = U(this.duration, this.labelInterval), t > g && (mt("slotLabelInterval results in too many cells"), this.labelInterval = null)), this.slotDuration && (e = U(this.duration, this.slotDuration), e > g && (mt("slotDuration results in too many cells"), this.slotDuration = null))), this.labelInterval && this.slotDuration && (r = U(this.labelInterval, this.slotDuration), !st(r) || 1 > r) ? (mt("slotLabelInterval must be a multiple of slotDuration"), this.slotDuration = null) : void 0
    }, I.prototype.ensureGridDuration = function () {
        var t, r, o, n, i;
        if (t = this.duration, !t) {
            if (t = this.view.intervalDuration, !t)if (this.labelInterval || this.slotDuration)for (i = this.ensureLabelInterval(), o = _.length - 1; o >= 0 && (r = _[o], t = e.duration(r), n = U(t, i), !(n >= y)); o += -1); else t = e.duration(s);
            this.duration = t
        }
        return t
    }, I.prototype.ensureLabelInterval = function () {
        var t, r, o, n, i, s, l, h, u;
        if (i = this.labelInterval, !i) {
            if (this.duration || this.slotDuration || this.ensureGridDuration(), this.slotDuration) {
                for (r = 0, s = _.length; s > r; r++)if (t = _[r], u = e.duration(t), h = U(u, this.slotDuration), st(h) && f >= h) {
                    i = u;
                    break
                }
                i || (i = this.slotDuration)
            } else for (o = 0, l = _.length; l > o && (t = _[o], i = e.duration(t), n = U(this.duration, i), !(n >= y)); o++);
            this.labelInterval = i
        }
        return i
    }, I.prototype.ensureSlotDuration = function () {
        var t, r, o, n, i, s, l, h;
        if (s = this.slotDuration, !s) {
            for (o = this.ensureLabelInterval(), r = 0, n = _.length; n > r; r++)if (t = _[r], h = e.duration(t), l = U(o, h), st(l) && l > 1 && f >= l) {
                s = h;
                break
            }
            s && this.duration && (i = U(this.duration, s), i > d && (s = null)), s || (s = o), this.slotDuration = s
        }
        return s
    }, I.prototype.computeHeaderFormats = function () {
        var t, e, r, o, n, i, s, l;
        switch (s = this.view, o = this.duration, n = this.labelInterval, i = P(n), l = this.opt("weekNumbers"), t = e = r = null, "week" !== i || l || (i = "day"), i) {
            case"year":
                t = "YYYY";
                break;
            case"month":
            ...
            case"week":
                ...
                break;
            case"day":
                o.asYears() > 1 ? t = this.opt("monthYearFormat") : o.asMonths() > 1 && (t = "MMMM"), l && (e = this.opt("weekFormat")), r = this.opt("smallDayDateFormat");
                break;
            case"hour":
                l && (t = this.opt("weekFormat")), o.asDays() > 1 && (e = this.opt("dayOfMonthFormat")), r = this.opt("smallTimeFormat");
                break;
            case"minute":
                n.asMinutes() / 60 >= f ? (t = this.opt("hourFormat"), e = "[:]mm") : t = this.opt("mediumTimeFormat");
                break;
            case"second":
                n.asSeconds() / 60 >= f ? (t = "LT", e = "[:]ss") : t = "LTS";
                break;
            case"millisecond":
                t = "LTS", e = "[.]SSS"
        }
        ...
        var t;
        if (t = window.console) {
            if (t.warn)return t.warn.apply(t, arguments);
            if (t.log)return t.log.apply(t, arguments)
        }
    }, a.views.timeline = {
        "class": W,
        defaults: {eventResizableFromStart: !0}
    }, a.views.timelineDay = {type: "timeline", duration: {days: 1}}, a.views.timelineWeek = {
        type: "timeline",
        duration: {weeks: 1}
    }, a.views.timelineMonth = {type: "timeline", duration: {months: 1}}, a.views.timelineYear = {
        type: "timeline",
        duration: {years: 1}
    }, R = function (e) {
        function r() {
        ...
        return Rt(r, e), r.mixin(S), r.prototype.resourceGrid = null, r.prototype.joiner = null, r.prototype.dividerEls = null, r.prototype.superHeaderText = null, r.prototype.isVGrouping = null, r.prototype.isHGrouping = null, r.prototype.groupSpecs = null, r.prototype.colSpecs = null, r.prototype.orderSpecs = null, r.prototype.rowHierarchy = null, r.prototype.resourceRowHash = null, r.prototype.nestingCnt = 0, r.prototype.isNesting = null, r.prototype.dividerWidth = null, r.prototype.initialize = function () {
            return r.__super__.initialize.apply(this, arguments), this.processResourceOptions(), this.resourceGrid = new x(this), this.rowHierarchy = new C(this), this.resourceRowHash = {}
        }, r.prototype.instantiateGrid = function () {
            return new b(this)
        }, r.prototype.processResourceOptions = function () {
            var t, e, r, o, n, i, s, l, h, u, a, p, c, d, f, g, y, v, w, m, b, R, S;
            for (t = this.opt("resourceColumns") || [], f = this.opt("resourceLabelText"), o = "Resources", R = null, t.length ? R = f : (S = this.opt("resourceText"), S || (S = function (t) {
                return t.title || t._id
            }), t.push({
                labelText: f || o,
                text: S
            })), m = [], n = [], s = [], a = !1, u = !1, p = 0, g = t.length; g > p; p++)r = t[p], r.group ? n.push(r) : m.push(r);
            for (m[0].isMain = !0, n.length ? (s = n, a = !0) : (l = this.opt("resourceGroupField"), l && (u = !0, s.push({
                field: l,
                text: this.opt("resourceGroupText"),
                render: this.opt("resourceGroupRender")
            }))), e = at(this.opt("resourceOrder")), b = [], c = 0, y = e.length; y > c; c++) {
                for (w = e[c], h = !1, d = 0, v = s.length; v > d; d++)if (i = s[d], i.field === w.field) {
                    i.order = w.order, h = !0;
                    break
                }
                h || b.push(w)
            }
            return this.superHeaderText = R, this.isVGrouping = a, this.isHGrouping = u, this.groupSpecs = s, this.colSpecs = n.concat(m), this.orderSpecs = b
        }, r.prototype.renderSkeleton = function () {
            return r.__super__.renderSkeleton.apply(this, arguments), this.renderResourceGridSkeleton(), this.joiner = new D("vertical", [this.resourceGrid.bodyScroller, this.timeGrid.bodyScroller]), this.initDividerMoving()
            ...
            var e, r, o, n, i;
            return r = this.opt("isRTL"), n = 30, o = this.el.width() - 30, i = this.getNaturalDividerWidth(), e = new l({
            ...
            var e;
            return e = this.getResourceRow(t._id), e ? (this.batchRows(), e.remove(), this.unbatchRows(), this.reinitializeCellFollowers()) : void 0
        }, r.prototype.cellFollower = null, r.prototype.reinitializeCellFollowers = function () {
            var e, r, o, n, i, s;
            for (this.cellFollower || (this.cellFollower = new T(this.resourceGrid.bodyScroller), this.cellFollower.isHFollowing = !1, this.cellFollower.isVFollowing = !0), n = [], i = this.rowHierarchy.getNodes(), r = 0, o = i.length; o > r; r++)s = i[r], s instanceof M && s.groupTd && (e = s.groupTd.find(".fc-cell-content"), e.length && n.push(e[0]));
            return this.cellFollower.setSprites(t(n))
        }, r.prototype.insertResource = function (t, e) {
            var r, o, n, i, s, l, h;
            for (h = new m(this, t), null == e && (i = t.parentId, i && (e = this.getResourceRow(i))), e ? this.insertRowAsChild(h, e) : this.insertRow(h), s = t.children, l = [], o = 0, n = s.length; n > o; o++)r = s[o], l.push(this.insertResource(r, h));
            return l
        }, r.prototype.insertRow = function (t, e, r) {
            var o;
            return null == e && (e = this.rowHierarchy), null == r && (r = this.groupSpecs), r.length ? (o = this.ensureResourceGroup(t, e, r[0]), o instanceof c ? this.insertRowAsChild(t, o) : this.insertRow(t, o, r.slice(1))) : this.insertRowAsChild(t, e)
            ...
            var r, o, n, i, s, l;
            if (this.orderSpecs.length)for (s = e.children, o = n = 0, i = s.length; i > n; o = ++n)if (l = s[o], r = this.compareResources(l.resource || {}, t.resource || {}), r > 0)return o;
            return null
        }, r.prototype.compareResources = function (t, e) {
            var r, o, n, i, s;
            for (i = this.orderSpecs, o = 0, n = i.length; n > o; o++)if (s = i[o], r = J(t[s.field], e[s.field]) * s.order)return r;
            return 0
        }, r.prototype.ensureResourceGroup = function (t, e, r) {
            var o, n, i, s, l, h, u, a, p, d, f;
            if (i = (t.resource || {})[r.field], n = null, r.order)for (p = e.children, s = l = 0, u = p.length; u > l; s = ++l) {
                if (f = p[s], o = J(f.groupValue, i) * r.order, 0 === o) {
                    n = f;
                    break
                }
                if (o > 0)break
            } else for (d = e.children, s = h = 0, a = d.length; a > h; s = ++h)if (f = d[s], f.groupValue === i) {
                n = f;
                break
            }
            return n || (n = this.isVGrouping ? new M(this, r, i) : new c(this, r, i), e.addChild(n, s)), n
        }, r.prototype.pairSegsWithRows = function (t) {
            var e, r, o, n, i, s, l, h;
            for (n = [], i = {}, e = 0, r = t.length; r > e; e++)h = t[e], s = h.resourceId || "", l = this.getResourceRow(s), l && (o = i[s], o || (o = [l, []], n.push(o), i[s] = o), o[1].push(h));
            return n
        }, r.prototype.rowAdded = function (t) {
            var e, r;
            return t instanceof m && (this.resourceRowHash[t.resource._id] = t), r = this.isNesting, e = Boolean(this.nestingCnt += t.depth ? 1 : 0), r !== e && (this.el.toggleClass("fc-nested", e), this.el.toggleClass("fc-flat", !e)), this.isNesting = e
        }, r.prototype.rowRemoved = function (t) {
            var e, r;
            return t instanceof m && delete this.resourceRowHash[t.resource._id], r = this.isNesting, e = Boolean(this.nestingCnt -= t.depth ? 1 : 0), r !== e && (this.el.toggleClass("fc-nested", e), this.el.toggleClass("fc-flat", !e)), this.isNesting = e
            ...
            var r, o, n, i, s, l, h, u, a, p;
            for (null == e && (e = !1), null == t && (t = this.getVisibleRows()), l = 0, u = t.length; u > l; l++)p = t[l], p.setTrInnerHeight("");
            for (s = function () {
                var o, n, i;
                for (i = [], o = 0, n = t.length; n > o; o++)p = t[o], r = p.getMaxTrInnerHeight(), e && (r += r % 2), i.push(r);
                return i
            }(), i = h = 0, a = t.length; a > h; i = ++h)p = t[i], p.setTrInnerHeight(s[i]);
            ...
            var t, e, r, o, n;
            for (r = this.rowHierarchy.getRows(), o = [], t = 0, e = r.length; e > t; t++)n = r[t], n instanceof u && o.push(n);
            return o
        ...
        var e, r, o, n;
        for (t = "string" == typeof t ? t.split(/\s*,\s*/) : t || [], o = [], e = 0, r = t.length; r > e; e++)n = t[e], o.push("-" === n.charAt(0) ? {
            field: n.substring(1),
            order: -1
        } : {field: n, order: 1});
        return o
    }, J = function (e, r) {
        return null == r ? -1 : null == e ? 1 : "string" === t.type(e) || "string" === t.type(r) ? String(e).localeCompare(String(r)) : e - r
    }, b = function (e) {
        function r() {
            return r.__super__.constructor.apply(this, arguments)
        }

        return Rt(r, e), r.mixin(v), r.prototype.eventRows = null, r.prototype.shownEventRows = null, r.prototype.tbodyEl = null, r.prototype.build = function () {
            var t;
            return this.eventRows = this.view.getEventRows(), this.shownEventRows = function () {
                var e, r, o, n;
                for (o = this.eventRows, n = [], e = 0, r = o.length; r > e; e++)t = o[e], t.isShown && n.push(t);
                return n
            }.call(this), this.rowCnt = this.shownEventRows.length
        }, r.prototype.clear = function () {
            return this.eventRows = null, this.shownEventRows = null
        }, r.prototype.getRowData = function (t) {
            return {resourceId: this.shownEventRows[t].resource._id}
        }, r.prototype.getRowEl = function (t) {
            return this.shownEventRows[t].getTr("event")
        }, r.prototype.renderSkeleton = function () {
            var e;
            ...
            var o, n, i, s, l, h, u, a, p, c, d, f;
            for (e = this.renderFillSegEls(t, e), a = [], l = [], o = 0, i = e.length; i > o; o++)d = e[o], d.resourceId ? a.push(d) : l.push(d);
            for (u = this.view.pairSegsWithRows(a), f = [], n = 0, s = u.length; s > n; n++)h = u[n], p = h[0], c = h[1], "bgEvent" === t && (p.bgSegs = c), p.isShown && f.push(h);
            return l.length && f.unshift([this, l]), this.renderFillInContainers(t, f, r)
        }, r.prototype.renderHelper = function (t, e) {
            var r, o;
            return o = this.eventsToSegs([t]), o = this.renderFgSegEls(o), r = this.view.pairSegsWithRows(o), this.renderHelperSegsInContainers(r, e)
            ...
            var t, e, o, n, i, s, l, h;
            for (h = r.__super__.queryScroll.apply(this, arguments), l = this.bodyScroller.scrollEl.offset().top, i = this.view.getVisibleRows(), o = 0, n = i.length; n > o; o++)if (s = i[o], s.resource && (t = s.getTr("event"), e = t.offset().top + t.outerHeight(), e > l)) {
                h.resourceId = s.resource._id, h.bottom = e - l;
                break
            }
            return h
            ...
            var e, r, o, n;
            return o = this.view.getResourceRow(t._id), o && (e = o.getTr("event")) ? (r = this.bodyScroller.innerEl.offset().top, n = e.offset().top - r, this.bodyScroller.scrollEl.scrollTop(n)) : void 0
        }, r
    }(I), r = 30, x = function () {
        function e(t) {
            var e;
        ...
        return e.prototype.view = null, e.prototype.headEl = null, e.prototype.el = null, e.prototype.tbodyEl = null, e.prototype.headScroller = null, e.prototype.bodyScroller = null, e.prototype.joiner = null, e.prototype.colGroupHtml = "", e.prototype.headTable = null, e.prototype.headColEls = null, e.prototype.headCellEls = null, e.prototype.bodyColEls = null, e.prototype.bodyTable = null, e.prototype.renderSkeleton = function () {
            return this.headScroller = new F("invisible-scroll", "hidden"), this.headScroller.contentEl.html(this.renderHeadHtml()), this.headEl.append(this.headScroller.el), this.bodyScroller = new F("auto", "invisible-scroll"), this.bodyScroller.contentEl.html("<table>" + this.colGroupHtml + "<tbody/></table>"), this.tbodyEl = this.bodyScroller.contentEl.find("tbody"), this.el.append(this.bodyScroller.el), this.joiner = new D("horizontal", [this.headScroller, this.bodyScroller]), this.headTable = this.headEl.find("table"), this.headColEls = this.headEl.find("col"), this.headCellEls = this.headScroller.contentEl.find("tr:last-child th"), this.bodyColEls = this.el.find("col"),
                this.bodyTable = this.el.find("table"), this.colMinWidths = this.computeColMinWidths(), this.applyColWidths(), this.initColResizing()
        }, e.prototype.renderHeadHtml = function () {
            var t, e, r, o, n, i, s, l, h, u, a;
            for (e = this.view.colSpecs, r = "<table>", t = "<colgroup>", s = 0, h = e.length; h > s; s++)a = e[s], t += a.isMain ? '<col class="fc-main-col"/>' : "<col/>";
            for (t += "</colgroup>", this.colGroupHtml = t, r += t, r += "<tbody>", this.view.superHeaderText && (r += '<tr class="fc-super"><th class="' + this.view.widgetHeaderClass + '" colspan="' + e.length + '"><div class="fc-cell-content"><span class="fc-cell-text">' + ot(this.view.superHeaderText) + "</span></div></th></tr>"), r += "<tr>", i = !0, o = l = 0, u = e.length; u > l; o = ++l)a = e[o], n = o === e.length - 1, r += '<th class="' + this.view.widgetHeaderClass + '"><div><div class="fc-cell-content">' + (a.isMain ? '<div class="fc-icon fc-expander-space" />' : "") + '<span class="fc-cell-text">' + ot(a.labelText || "") + "</span></div>" + (n ? "" : '<div class="fc-col-resizer"></div>') + "</div></th>";
            ...
            var n, i, s, h;
            return n = this.colWidths = this.queryColWidths(), n.pop(), n.push("auto"), h = n[t], s = Math.min(this.colMinWidths[t], r), i = new l({
                dragStart: function (t) {
                    return function () {
                    ...
                    return function (r, o) {
                        var i;
                        return i = h + (e.isRTL ? -r : r), i = Math.max(i, s), n[t] = i, e.applyColWidths()
                    }
                }(this), dragStop: function (t) {
                    return function () {
            ...
            var t, e, r, o, n, i, s, l, h, u, a, p, c, d, f, g, y;
            for (r = this.colMinWidths, n = this.colWidths, t = !0, e = !1, y = 0, u = 0, c = n.length; c > u; u++)o = n[u], "number" == typeof o ? y += o : (t = !1, o && (e = !0));
            for (l = e ? "auto" : "", s = function () {
                var t, e, r;
                for (r = [], h = t = 0, e = n.length; e > t; h = ++t)o = n[h], r.push(null != o ? o : l);
                return r
            }(), g = 0, h = a = 0, d = s.length; d > a; h = ++a)i = s[h], g += "number" == typeof i ? i : r[h];
            for (h = p = 0, f = s.length; f > p; h = ++p)i = s[h], this.headColEls.eq(h).width(i), this.bodyColEls.eq(h).width(i);
        ...
        return e.prototype.view = null, e.prototype.parent = null, e.prototype.prevSibling = null, e.prototype.children = null, e.prototype.depth = 0, e.prototype.hasOwnRow = !1, e.prototype.trHash = null, e.prototype.trs = null, e.prototype.isRendered = !1, e.prototype.isExpanded = !0, e.prototype.isShown = !1, e.prototype.addChild = function (t, e) {
            ...
            var e, r, o, n, i, s, l, h, u, a;
            for (e = this.children, o = !1, r = n = 0, s = e.length; s > n; r = ++n)if (a = e[r], a === t) {
                o = !0;
                break
            }
            if (o) {
                for (r < e.length - 1 && (e[r + 1].prevSibling = t.prevSibling), e.splice(r, 1), t.recursivelyUnrender(), h = t.getNodes(), i = 0, l = h.length; l > i; i++)u = h[i], u.removed();
            ...
            var t, e;
            for (e = this; e;) {
                if (e.prevSibling)for (e = e.prevSibling; t = e.getLastChild();)e = t; else e = e.parent;
            ...
            if (this.trHash = {}, s = [], this.hasOwnRow) {
                ...
                for (l in r)n = r[l], i = t("<tr/>"), this.trHash[l] = i, s.push(i[0]), o = "render" + B(l) + "Content", this[o] && this[o](i), e ? e.trHash[l].after(i) : n.prepend(i)
            }
            return this.trs = t(s).on("click", ".fc-expander", pt(this, "toggleExpanded")), this.isRendered = !0
        }, e.prototype.unrender = function () {
            var e, r, o, n;
            if (this.isRendered) {
                e = this.trHash;
                for (o in e)r = e[o], n = "unrender" + B(o) + "Content", this[n] && this[n](r);
            ...
            var t, e, r, o, n;
            if (!this.isShown && (this.isRendered ? this.trs.css("display", "") : this.render(), this.isExpanded ? this.indicateExpanded() : this.indicateCollapsed(), this.isShown = !0, this.shown(), this.isExpanded)) {
            ...
            return e = 0, t.each(this.trHash, function (t) {
                return function (t, r) {
                    var o;
                    return o = r.find("> td:not([rowspan]):first > div"), e = Math.max(o.height(), e)
                }
            }(this)), e
        }, e.prototype.setTrInnerHeight = function (t) {
            return this.trs.find("> td:not([rowspan]):first > div").height(t)
        ...
        return Rt(r, e), r.prototype.groupSpec = null, r.prototype.groupValue = null, r.prototype.rowRemoved = function (t) {
        ...
        return Rt(r, e), r.prototype.hasOwnRow = !0, r.prototype.renderSpreadsheetContent = function (e) {
            var r;
        ...
        return Rt(r, e), r.prototype.rowspan = 0, r.prototype.leadingTr = null, r.prototype.groupTd = null, r.prototype.rowShown = function (t) {
        ...
        return Rt(e, t), e.prototype.hasOwnRow = !0, e.prototype.segContainerEl = null, e.prototype.segContainerHeight = null, e.prototype.innerEl = null, e.prototype.bgSegContainerEl = null, e.prototype.isSegsRendered = !1, e.prototype.bgSegs = null, e.prototype.fgSegs = null, e.prototype.renderEventContent = function (t) {
            return t.html('<td class="' + this.view.widgetContentClass + '"> <div> <div class="fc-event-container" /> </div> </td>'), this.segContainerEl = t.find(".fc-event-container"), this.innerEl = this.bgSegContainerEl = t.find("td > div"), this.isSegsRendered ? void 0 : (this.bgSegs && this.view.timeGrid.renderFillInContainer("bgEvent", this, this.bgSegs), this.fgSegs && this.view.timeGrid.renderFgSegsInContainers([[this, this.fgSegs]]), this.isSegsRendered = !0)
        ...
        return Rt(r, e), r.prototype.resource = null, r.prototype.rowAdded = function (t) {
            ...
            var r, o, n, i, s, l, h, u, a, p;
            for (h = this.resource, l = this.view.colSpecs, u = [], i = 0, s = l.length; s > i; i++)r = l[i], r.group || (n = r.field ? h[r.field] || null : h, p = "function" == typeof r.text ? r.text(h, n) : n, o = t('<div class="fc-cell-content">' + (r.isMain ? this.renderGutterHtml() : "") + '<span class="fc-cell-text">' + (p ? ot(p) : "&nbsp;") + "</span></div>"), "function" == typeof r.render && (o = r.render(h, o, n) || o), a = t('<td class="' + this.view.widgetContentClass + '"/>').append(o), r.isMain && a.wrapInner("<div/>"), u.push(e.append(a)));
            return u
    ...
    }(u), a.views.timeline.resourceClass = R
});