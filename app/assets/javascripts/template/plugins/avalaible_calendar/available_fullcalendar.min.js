    ...
    Grid.mixin({
        ...
        renderFgSegEls: function (segs, disableResizing) {
            ...
            if (segs.length) { // don't build an empty html string
                ...
                for (i = 0; i < segs.length; i++) {
                    //html += (segs[i].event.type == 'reminder' ? '' : this.fgSegHtml(segs[i], disableResizing));
...
// NOTE: all the segs being passed around in here are foreground segs
        ...
        slatRowHtml: function () {
            ...
            while (slotTime < this.maxTime) {
                ...
                axisHtml =
                    ...
                    (isLabeled ?
                        '<span class="move-top-17-3">' + // for matchCellWidths
    ...
    TimeGrid.mixin({
        ...
        fgSegHtml: function (seg, disableResizing) {
            ...
            if (seg.event.type == 'reminder') return '<a></a>';
            return '<a class="' + classes.join(' ') + '"' +
                (event.url ?
                    ' href="' + htmlEscape(event.url) + '"' :
                        ''
                ...
                '<div class="row col-md-12 text-center little-top">' +
                '<button class="btn btn-danger unavailable-truck" data-start-time="' + event.start.format('YYYY-MM-DD hh:mm A') + '" data-end-time="' + event.end.format('YYYY-MM-DD hh:mm A') + '">Unavailable</button>' +
                '<button class="btn btn-success available-truck" data-start-time="' + event.start.format('YYYY-MM-DD hh:mm A') + '" data-end-time="' + event.end.format('YYYY-MM-DD hh:mm A') + '" >Available</button>' +
                '</div>') : '' ) +
                '</div>' +
                '<div class="fc-bg"/>' +
    ...
    function Header(calendar, options) {
        ...
        function renderSection(position, opts) {
            if (opts != "notd") {
                ...
                var sectionEl = $('<div class="btn btn-none"/>');
            }
